        ...
        //};
            ...
            if (isFirstRun == true)
            {
                ...
                foreach (ElementData element in elements)
                {
                    ...
                    newElement.GetComponentInChildren<Element>().SetFromElementData(element);
            ...
            else
            {
                ...
                {
                    existingElementObject.parent.GetComponentInChildren<Element>().SetFromElementData(elements[i]);
